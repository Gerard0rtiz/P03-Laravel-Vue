    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between pb-2 mb-2">
                <h5 class="card-title">Añade una imputacion nueva</h5>
            </div>
            ...
            <form @submit.prevent="addImputacion()" >
              <div class="form-group mb-2">
                ...
                <button type="submit" class="btn btn-primary mt-4 mb-4">Crear imputacion</button>
      </form>
    </div>
  </div>
</template>
